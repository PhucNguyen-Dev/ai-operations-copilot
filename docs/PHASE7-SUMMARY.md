...
- F-030 Internal AI Documentation/SOP: 7 SOPs, with the Troubleshooting SOP sourced from real incidents (docs/dev-fix-log.md)
...
Context from the build period (documented in dev-fix-log): the free tier's per-model daily quota exhausted once
