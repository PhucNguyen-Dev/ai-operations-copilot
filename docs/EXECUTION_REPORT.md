...
- **No lint script is a real gap.** We ran no invented lint command and do not rebrand typecheck or build as lint. Agreeing a lint command with the owner belongs in a future authorized change.
